...
class AdvertisementWidget extends WP_Widget {
	...
	*/
		...
		<div class="about-widget widget">
			...
			<div class="about-info">
				<?php if($display_image) { ?>
					<?php if($instance['url']) {  ?>
						<a target="_blank" href="<?php echo esc_url($instance['url']) ?>">
	...
	public function update($new_isntance, $old_instance) {
		$instance = array();
		$instance['title'] = saniteze_texdt_field($new_instance['title']);
	...
	public function form($instance){
		...
		<p>
			...
			<input class="imgph" id="<?php echo esc_attr($this->get_field_id('image')) ?>" name="<?php echo esc_attr($this->get_field_name('image')) ?>" type="hidden" value="<?php echo esc_attr($instance['image']) ?>">
